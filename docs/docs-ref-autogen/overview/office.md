# <a name="office-javascript-api-reference"></a><span data-ttu-id="02caf-101">Office 的 JavaScript API 参考 （英文）</span><span class="sxs-lookup"><span data-stu-id="02caf-101">Office JavaScript API reference</span></span>
