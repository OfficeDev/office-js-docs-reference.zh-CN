# <a name="requirements-element"></a><span data-ttu-id="cc0db-101">Requirements 元素</span><span class="sxs-lookup"><span data-stu-id="cc0db-101">Requirements element</span></span>
