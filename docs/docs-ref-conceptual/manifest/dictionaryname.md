# <a name="dictionaryname-element"></a><span data-ttu-id="135a6-101">DictionaryName 元素</span><span class="sxs-lookup"><span data-stu-id="135a6-101">DictionaryName element</span></span>
