# <a name="defaultsettings-element"></a><span data-ttu-id="40d70-101">DefaultSettings 元素</span><span class="sxs-lookup"><span data-stu-id="40d70-101">DefaultSettings element</span></span>
