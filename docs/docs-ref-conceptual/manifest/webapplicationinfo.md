# <a name="webapplicationinfo-element"></a><span data-ttu-id="f08df-101">WebApplicationInfo 元素</span><span class="sxs-lookup"><span data-stu-id="f08df-101">WebApplicationInfo element</span></span>
