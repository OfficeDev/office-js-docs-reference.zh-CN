# <a name="sourcelocation-element"></a><span data-ttu-id="d14fd-101">SourceLocation 元素</span><span class="sxs-lookup"><span data-stu-id="d14fd-101">SourceLocation element</span></span>
