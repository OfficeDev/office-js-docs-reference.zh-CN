# <a name="mobileformfactor-element"></a><span data-ttu-id="f0831-101">MobileFormFactor 元素</span><span class="sxs-lookup"><span data-stu-id="f0831-101">MobileFormFactor element</span></span>
