# <a name="mobileformfactor-element"></a><span data-ttu-id="513cb-101">MobileFormFactor 元素</span><span class="sxs-lookup"><span data-stu-id="513cb-101">MobileFormFactor element</span></span>
