# <a name="highresolutioniconurl-element"></a><span data-ttu-id="9d35f-101">HighResolutionIconUrl 元素</span><span class="sxs-lookup"><span data-stu-id="9d35f-101">HighResolutionIconUrl element</span></span>
