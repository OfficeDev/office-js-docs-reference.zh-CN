# <a name="appdomains-element"></a><span data-ttu-id="15f50-101">AppDomains 元素</span><span class="sxs-lookup"><span data-stu-id="15f50-101">AppDomains element</span></span>
