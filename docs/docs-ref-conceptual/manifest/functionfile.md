# <a name="functionfile-element"></a><span data-ttu-id="cdb76-101">FunctionFile 元素</span><span class="sxs-lookup"><span data-stu-id="cdb76-101">FunctionFile element</span></span>
