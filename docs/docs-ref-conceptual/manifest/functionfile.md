# <a name="functionfile-element"></a><span data-ttu-id="87c5d-101">FunctionFile 元素</span><span class="sxs-lookup"><span data-stu-id="87c5d-101">FunctionFile element</span></span>
