# <a name="desktopformfactor-element"></a><span data-ttu-id="c12ff-101">DesktopFormFactor 元素</span><span class="sxs-lookup"><span data-stu-id="c12ff-101">DesktopFormFactor element</span></span>
