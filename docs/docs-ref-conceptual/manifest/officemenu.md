# <a name="officemenu-element"></a><span data-ttu-id="aecf0-101">OfficeMenu 元素</span><span class="sxs-lookup"><span data-stu-id="aecf0-101">OfficeMenu element</span></span>
