# <a name="getstarted-element"></a><span data-ttu-id="9abfd-101">GetStarted 元素</span><span class="sxs-lookup"><span data-stu-id="9abfd-101">GetStarted element</span></span>
