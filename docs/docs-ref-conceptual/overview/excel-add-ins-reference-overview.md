# <a name="excel-javascript-api-overview"></a><span data-ttu-id="98fdb-101">Excel 的 JavaScript API 概述</span><span class="sxs-lookup"><span data-stu-id="98fdb-101">Excel JavaScript API overview</span></span>
