# <a name="onenote-javascript-api-overview"></a><span data-ttu-id="f0591-101">OneNote JavaScript API 概述</span><span class="sxs-lookup"><span data-stu-id="f0591-101">OneNote JavaScript API overview</span></span>
