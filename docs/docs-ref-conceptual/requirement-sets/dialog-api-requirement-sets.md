...
|  要求集  | Office 2013 for Windows | Office 2016 for Windows（MSI 安装）   | Office 365 的 Windows （C2R 安装）   |  Office 365 for iPad  |  Office 365 for Mac  | Office Online  |  Office Online Server  |
|:-----|-----|:-----|:-----|:-----|:-----|:-----|:-----|
